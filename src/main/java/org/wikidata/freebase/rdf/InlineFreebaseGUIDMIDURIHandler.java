...
public class InlineFreebaseGUIDMIDURIHandler extends InlineURIHandler {
	...
	private final static String MID_PREFIX = "m.0";
	private final static String GUID_PREFIX = "g.1";
	...
	private static long midToLong(String mid) {
		long value = 0;
		int start = 0;
	...
	private static String longToGuid(long l) {
	...
	private static long guidToLong(String guid) {
	...
	private static String longToMid(final String prefix, long numericId) {
		final StringBuilder sb = new StringBuilder(16);
		final StringBuilder sbPrefix = new StringBuilder(prefix);
		while (numericId > 0) {
